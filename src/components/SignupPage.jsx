    ...
    <div className="signup-page">
      ...
      <div className="signup-card">
        <div className="signup-brand">
          <span className="signup-brand-mark">pd</span>
          PandaDoc
        </div>
        
        <h1 className="signup-title">Start a free account</h1>
        <span className="signup-subhead">No credit card required</span>
        ...
        <p className="signup-terms">
          By signing up to use PandaDoc, you agree to our
